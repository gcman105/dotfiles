...
complete -c fnm -n "__fish_use_subcommand" -f -a "unalias" -d 'Remove an alias definiton'
...
complete -c fnm -n "__fish_seen_subcommand_from unalias" -l log-level -d 'The log level of fnm commands'
